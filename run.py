...
if __name__ == '__main__':
    ...
    # SCNet: patch size p_s for each temporal scale (MAPE module)
    parser.add_argument('--patch_sizes', type=int, nargs='+', default=[48, 24, 12, 6])
    parser.add_argument('--CKA_flag', type=int, default=0, help='CKA_flag')
    parser.add_argument('--result_file', type=str, default='result_long_term_forecast.txt', help='file to save test results')
